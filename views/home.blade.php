...
<section class="intro">
    <div class="intro__info">
        ...
        <button type="button" class="intro__info-takebtn" onclick="goToRooms()">TAKE A TOUR</button>
        <button type="button" class="intro__info-learnbtn" onclick="goToAboutUs()">LEARN MORE</button>
    </div>

    <form id="availability-form" name="dates-form" class="intro__form" action="" method="post">
        ...
        <input name="departure" type="date" id="departure" class="intro__form-departureinp">
        <br>
...
<section class="about">
    <article class="about__intro">
        ...
        <button type="button" class="about__intro-bookbtn" onclick="goToRooms()">BOOK NOW</button>
    </article>
...
<section class="introvideo">
    <div class="introvideo__innercontent">
        <div class="introvideo__layout">
            ...
            <button type="button" class="introvideo__button" onclick="goToRooms()">BOOK NOW</button>
        </div>
    </div>
</section>
