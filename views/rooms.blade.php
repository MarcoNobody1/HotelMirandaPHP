    ...
    <section class="roomshow">
        <div class="rommshow__inner">
            <div class="roomshow__roomwrapper">
                <img class="roomshow__photo" src="../assets/Rooms_swiper/room 1.jpg" alt="Hotel Room">
                ...
                <div class="roomshow__desc">
                    <h3 class="roomshow__title">Minimal Duplex Room</h3>
                    <p class="roomshow__content">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        eiusmod
                        tempor incididunt ut labore et dolore.</p>
                    <span class="roomshow__price">$345/Night</span>
            ...
            <img class="roomshow__pagination-cover" src="../assets/Rooms_swiper/Pagination.png" alt="Future Pagination Here!">
            <span class="roomshow__explanation">Future Pagination Here!</span>
        </div>
    </section>
@endsection
@section('scripts')
